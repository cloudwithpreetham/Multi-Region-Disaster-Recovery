...
# Health checks feed the latency routing records below — Route53
# automatically excludes an unhealthy region's record from answers,
# so this also gives basic failover behavior even before Day 10's
# dedicated failover routing policy work.
